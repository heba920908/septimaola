...
export default function AudioRequirements() {
  const requirements = [
    ...
    'Consola de mezcla: mínimo 9 canales de entrada (banda de 6 miembros), con suficientes buses auxiliares para 3 mezclas de monitores.',
    'La batería requiere tres canales de entrada: bombo, caja y overhead (mono si los canales son limitados).',
