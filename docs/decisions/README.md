...
| [0014](0014-social-insights-json-report.md) | Social insights JSON report via `insights-report` | Accepted |
| [0015](0015-social-insights-visualization.md) | Social insights visualization and native AI analyzer | Accepted |
